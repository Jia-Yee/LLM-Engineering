...
cells = [
    nbf.v4.new_markdown_cell(
        ...
        "## Introduction\n"
        "The context window (or context length) determines how much text the model can process "
        "in a single operation. It represents the maximum number of tokens that can be included "
        "in both the input prompt and the generated output combined.\n\n"
        "Key aspects:\n"
    ...
    nbf.v4.new_markdown_cell(
        "## Examples\n\n"
        "Let's explore how context length affects the model's ability to process and maintain "
        "information. We'll use prompts of different lengths to demonstrate the impact."
    ),
    nbf.v4.new_code_cell(
...
# Write the notebook
nbf.write(nb, "notebooks/prompt-engineering/parameters/08_context_window.ipynb")
